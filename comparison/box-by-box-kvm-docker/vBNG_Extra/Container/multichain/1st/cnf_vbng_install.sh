...
bin memif_socket_filename_add_del add id 2 filename /root/sockets/memif1-2.sock
create interface memif id 1 socket-id 1 hw-addr 52:54:00:00:00:aa slave rx-queues 2 tx-queues 2
create interface memif id 3 socket-id 2 hw-addr 52:54:00:00:01:aa master rx-queues 2 tx-queues 2
set int ip addr memif1/1 172.16.10.10/24
set int ip addr memif2/3 172.16.30.10/24
set int state memif1/1 up
set int state memif2/3 up

set ip arp static memif1/1 172.16.10.100 8a:fd:d5:d5:d6:b6
set ip arp static memif2/3 172.16.30.11 52:54:00:00:01:bb

ip route add 172.16.64.0/18 via 172.16.10.100
ip route add 172.16.192.0/18 via 172.16.30.11
EOF
