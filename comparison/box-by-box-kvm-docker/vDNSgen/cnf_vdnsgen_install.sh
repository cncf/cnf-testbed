...
#set interface ip address tapcli-0 40.30.20.90/24
#EOF

# Run instantiation script
cd /opt
cp -r /vDNSgen/dns_streams /opt/
cp /vDNSgen/cnf_vdnsgen_init.sh .
cp /vDNSgen/cnf_vdnsgen.sh /etc/init.d
update-rc.d cnf_vdnsgen.sh defaults
