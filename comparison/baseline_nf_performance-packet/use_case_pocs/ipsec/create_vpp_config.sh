...
function clean_vpp_config () {
    ...
    VPP_CONF_FILE="vEdge_ipsec_vpp.conf"
...
function generate_vpp_config_intel () {
    ...
    append_vpp_config "create bridge-domain 3"
    append_vpp_config ""
    sockets=$(( "${CHAINS}" *  2 ))
    ...
    append_vpp_config "set int l2 bridge memif1/1 1"
    append_vpp_config "set int l2 bridge memif2/2 2"
    append_vpp_config "set int l2 bridge memif3/3 2"
    append_vpp_config "set int l2 bridge memif4/4 3"
    set +u
    append_vpp_config "set int l2 bridge ${VPP_INTERFACES[1]}${VLANS[1]/#/.} 3"
    append_vpp_config ""
