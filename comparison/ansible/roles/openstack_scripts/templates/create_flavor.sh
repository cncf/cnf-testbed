...
if [[ ! $(openstack flavor list | grep c0. | wc -l) -ge 2 ]]; then
  openstack flavor create --id 10 --vcpus 3 --ram 8192 --disk 10 --property hw:cpu_policy=dedicated --property hw:mem_page_size=2048 --property hw:numa_cpus.0=0,1,2 --property hw:numa_mem.0=8192 --property hw:numa_nodes=1 vnf.3c
